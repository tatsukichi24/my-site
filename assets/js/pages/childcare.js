(function () {
  ...
  function requestedPersonId() {
    ...
    var id = params.get("person");
    return id && personMap.has(id) ? id : "";
  }
  ...
  var requestedId = requestedPersonId();
  var initial = navItems.find(function (button) {
    return button.classList.contains("is-active");
  });
  activatePerson(
    requestedId || (initial ? initial.getAttribute("data-target-person") : navItems[0].getAttribute("data-target-person")),
    Boolean(requestedId)
  );
...
(function () {
  ...
  var bubble = flow.querySelector(".jgs-childcare-flow__bubble-img");
  ...
  if (!caseId || !caseLabel || !bubble || !portrait || !rightImage || !cards.length) return;
  ...
  var flowItems = [
    {
      personId: "rie-takahata",
      caseId: "CASE 01",
      caseLabel: "メリハリ両立型の働き方",
      bubbleSrc: "../../assets/recruit-image/work-flow_text.svg",
      bubbleWidth: "510",
      bubbleHeight: "110",
    ...
    {
      personId: "shizuka-sugihara",
      caseId: "CASE 02",
      caseLabel: "チーム安心サポート型の働き方",
      bubbleSrc: "../../assets/recruit-image/recruit_childcare_work-flow_text_shizuka-sugihara.svg",
      bubbleWidth: "371",
      bubbleHeight: "80",
      portraitSrc: "../../assets/recruit-image/recruit_childcare_shizuka-sugihara.png",
      portraitWidth: "276",
      portraitHeight: "389",
      portraitAlt: "杉原静さんの写真",
      workStyle: "パート",
      work: "販売営業",
      rightSrc: "../../assets/recruit-image/recruit_work-flow_shizuka-sugihara_right.svg",
      rightWidth: "665",
      rightHeight: "683",
      rightAlt: "杉原静さんの1日の業務スケジュール",
    },
    {
      personId: "tomoharu-kishi",
      caseId: "CASE 03",
      caseLabel: "責任とやりがいリーダー型の働き方",
      bubbleSrc: "../../assets/recruit-image/recruit_childcare_work-flow_text_tomoharu-kishi.svg",
      bubbleWidth: "371",
      bubbleHeight: "80",
      ...
      workStyle: "正社員",
      work: "販売営業",
      rightSrc: "../../assets/recruit-image/recruit_work-flow_tomoharu-kishi_right.svg",
      rightWidth: "665",
      rightHeight: "497",
      rightAlt: "岸智治さんの1日の業務スケジュール",
    },
  ];
  ...
  function activateFlow(index) {
    ...
    setImageAttrs(bubble, item.bubbleSrc, item.bubbleWidth, item.bubbleHeight, "");
  ...
  function requestedFlowIndex() {
    var params = new URLSearchParams(window.location.search);
    var id = params.get("flow");
    if (!id) return -1;

    return flowItems.findIndex(function (item) {
  ...
  var initialFlowIndex = requestedFlowIndex();
  activateFlow(initialFlowIndex < 0 ? 0 : initialFlowIndex);
})();
